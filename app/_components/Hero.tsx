...
function Hero() {
    ...
    const onSend=()=>{
        ...
        //Nagivate to create Trip Planner Web Page
  ...
  return (
    <div className='mt-24 w-full flex justify-center'>
        ...
        <div className='max-w-3xl w-full text-center space-y-6'>
            ...
            <p className='text-lg'>Tell me what you want, and I'll handle the rest: Flignts, Hotels, trip Planner - all in seconds</p>
             {/* input box */}
             <div>
             ...
             thumbnailSrc="https://mma.prnewswire.com/media/2401528/1 MindtripProduct.jpg?p=facebook"
